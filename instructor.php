                            ...
                            <ul class="lab-ul">
                                ...
                                <li>
                                    ...
                                    <ul class="lab-ul">
                                        ...
                                        <li><a href="instructor.html" class="active">Instructor</a></li>
                                        <li>
    ...
    <div class="category-section padding-tb section-bg style-3">
        <div class="container">
            <div class="section-header text-center">
                ...
                <h2 class="title">Discover Your Potential. Make A Global Impact.</h2>
            </div>
                ...
                <div class="row g-4 justify-content-center row-cols-lg-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="assets/images/category/icon/15.jpg" alt="category">
                                </div>
                                <div class="category-content">
                                    <a href="#"><h4>Build Your Brand</h4></a>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="assets/images/category/icon/16.jpg" alt="category">
                                </div>
                                <div class="category-content">
                                    <a href="#"><h4>Plan Your Course</h4></a>
                                    <p>Like graphic design, business anaytics coding and much more</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="assets/images/category/icon/17.jpg" alt="category">
                                </div>
                                <div class="category-content">
                                    <a href="#"><h4>Help Shape Future</h4></a>
                                    <p>Like graphic design, business anaytics coding and much more</p>
                                </div>
                            </div>
                        </div>
