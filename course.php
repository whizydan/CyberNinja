                                ...
                                <div class="col">
                                    <div class="select-item">
                                        <select>
                                            ...
                                            <option value="academy">Wireshark</option>
                                            <option value="agency">Android OS</option>
                                            <option value="app">IOS</option>
                                            <option value="bar">Social Engineering</option>
                                        </select>
                        ...
                        <div class="course-showing-part-right d-flex flex-wrap align-items-center">
                            ...
                            <div class="select-item">
                                <select>
                                    ...
                                    <option value="html">A-z</option>
                                    <option value="css">Z-a</option>
                                    <option value="php">By date</option>
                                </select>
                                <div class="select-icon">
                                    <i class="icofont-rounded-down"></i>
                                </div>
                        ...
                        <div class="course-item">
                            <div class="course-inner">
                                ...
                                <div class="course-content">
                                    ...
                                    <a href="course-single.html"><h5>Fundamentals of Wireless Network Security</h5></a>
                                    <div class="course-details">
                                        <div class="couse-count"><i class="icofont-video-alt"></i> 12x Lesson</div>
                        ...
                        <div class="course-item">
                            <div class="course-inner">
                                ...
                                <div class="course-content">
                                    ...
                                    <a href="course-single.html"><h5>Network Spoofing</h5></a>
                                    <div class="course-details">
                                        <div class="couse-count"><i class="icofont-video-alt"></i> 14x Lesson</div>
                                        <div class="couse-topic"><i class="icofont-signal"></i> Online Class</div>
                                    </div>
                                    <div class="course-footer">
                                        <div class="course-author">
                        ...
                        <div class="course-item">
                            <div class="course-inner">
                                ...
                                <div class="course-content">
                                    ...
                                    <a href="course-single.html"><h5>Apk payload injection</h5></a>
                                    <div class="course-details">
                        ...
                        <div class="course-item">
                            <div class="course-inner">
                                ...
                                <div class="course-content">
                                    ...
                                    <a href="course-single.html"><h5>Algorithm Analysis</h5></a>
                                    <div class="course-details">
                                        <div class="couse-count"><i class="icofont-video-alt"></i> 18x Lesson</div>
                                        <div class="couse-topic"><i class="icofont-signal"></i> Online Class</div>
                                    </div>
                        ...
                        <div class="course-item">
                            <div class="course-inner">
                                ...
                                <div class="course-content">
                                    ...
                                    <a href="course-single.html"><h5>How to find zero day vulnerabilities in a web server</h5></a>
                                    <div class="course-details">
                                        <div class="couse-count"><i class="icofont-video-alt"></i> 18x Lesson</div>
                                        <div class="couse-topic"><i class="icofont-signal"></i> Online Class</div>
                                    </div>
                        ...
                        <div class="course-item">
                            <div class="course-inner">
                                ...
                                <div class="course-content">
                                    ...
                                    <a href="course-single.html"><h5>Brute force attacks on wireless networks</h5></a>
                                    <div class="course-details">
                                        <div class="couse-count"><i class="icofont-video-alt"></i> 18x Lesson</div>
                                        <div class="couse-topic"><i class="icofont-signal"></i> Online Class</div>
                                    </div>
